...
<script>
	...
	export default {
		...
		methods: {
			...
			headClick(){
				uni.navigateTo({
					url: "/pageB/violations/userUseCarMessage/userUseCarMessage?order_id=" + this.bikeInfo.last_order_id,
				})
			},
			cellClick(e){
				if (e == 3) {
					uni.navigateTo({
						url: "/pageB/violations/chooseViolationsType/chooseViolationsType",
					})
				}else{
