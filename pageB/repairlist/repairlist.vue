				...
				wx.scanCode({
					...
					success: res => {
						...
						if(this.type==99){
							if (this.type == '99') {
								uni.navigateTo({
									url: "/pageB/violations/reportViolations/reportViolations",
									success: res => {},
									fail: () => {},
									complete: () => {}
								});
						...
						switch (type) {
										...
										switch (chids[j].uri) {
											case '1.0':
												tempobj = {
													name: '维修入库',
													val: '',
													url: '/pageA/map/map?text=全部故障车辆&type=1.1&name=维修',
												}
											...
											case '1.1':
												tempobj = {
													...
													url: '/pageB/repairPage/repairenter/repairenter',
												}
												templist.push(tempobj)
												break
										}
							...
							case '8':
										...
										switch (chids[j].uri) {
											case '8.0':
												tempobj = {
													name: '入库',
													val: '',
													url: `/pageB/stockPage/putstorage/putstorage?type=0`,
												}
												templist.push(tempobj)
												break
											case '8.1':
								...
								tempobj = {
									name: '车辆列表',
									val: '',
									url: '/pageB/stockPage/bikelist/bikelist',
								}
								templist.push(tempobj)
								tempobj = {
									name: '删除',
							...
							case '9':
								templist = [
									...
									// 	val: '',
									// 	// url: '/pages/map/map',
									// 	url: `/pages/map/map?name=创建停车区&type=9.1`
									// },
									{
										name: '创建车站',
										val: '',
										url: `/pageA/map/map?name=创建车站&type=9`
									},
									{
											name: '创建停车区',
											val: '',
										...
										switch (chids[j].uri) {
											...
											case '10.2':
												tempobj = {
													name: '处理',
													val: '',
													url: '/pageB/violations/reportViolationsList/reportViolationsList?type=0',
												}
												templist.push(tempobj)
												break
											case '10.3':
												tempobj = {
													name: '违章审核',
													val: '',
													url: '/pageB/violations/reportViolationsList/reportViolationsList?type=10',
												}
												templist.push(tempobj)
												break	
										}
										...
										switch (chids[j].uri) {
											case '11.0':
												tempobj = {
													name: '车辆疑似被盗',
													val: '',
													url: '/pageA/investCarPage/investview/investview?type=0',
												}
												templist.push(tempobj)
												break
											case '11.1':
												tempobj = {
													name: '车辆疑似报修',
													val: '',
													url: '/pageA/investCarPage/investview/investview?type=1',
												}
												templist.push(tempobj)
												break
											case '11.2':
												tempobj = {
													name: '车辆疑似失联',
													val: '',
													url: '/pageA/investCarPage/investview/investview?type=2',
												}
												templist.push(tempobj)
												break
										}
							...
							case '14':
								templist = [{
										name: '手动输入',
										val: '',
										url: '/pageA/manualscan/manualscan?urls=/pageA/endOrder/endorder/endorder&type=14',
									},
									{
										name: '扫码输入',
										val: '',
				...
				this.$httpReq(options).then((res) => {
					...
					if (res.status == 0) {
						...
						if (this.type == '99') {
							...
							uni.navigateTo({
								url: "/pageA/endOrder/endorder/endorder",
								success: res => {},
								fail: () => {},
								complete: () => {}
							});
				...
				if (this.type == '8') {
					...
					wx.scanCode({
						...
						success: res => {
							...
							uni.navigateTo({
								url: `/pageA/ecutest/ecutest?imei=${imei}`,
								success: res => {},
								fail: () => {},
								complete: () => {}
							});
					...
					uni.navigateTo({
						url: `/pageB/stockPage/putstorage/putstorage?type=${item.val}`,
						success: res => {},
						fail: () => {},
						complete: () => {}
					});
			...
			switch (e.type) {
				...
				case '8':
					this.repairlist = [{
							name: '手动输入',
							val: '',
							url: `/pageA/manualscan/manualscan?urls=/pageB/stockPage/stockmanage/stockmanage&&type=8`,
						},
						{
							name: '扫码投放',
							val: '',
							url: '/pageA/movecarPage/removecarrecord/removecarrecord',
						}
					]
					break;
				case '10':
					this.repairlist = [{
						...
						},
						{
							name: '处理',
							val: '',
							url: '/pageB/violations/reportViolationsList/reportViolationsList',
						}
					]
					break;
				case '11':
