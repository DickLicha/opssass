<template>
	<view>
		<view class="index-top">
			<view class="index-top-bg theme-bg" :style="'height:'+bgheight"></view>
			<view class="index-top-box">
				...
				<view class='timeselect-view'>
					...
					<view class='data-box' v-if="(limitorder.ddjet || limitorder.cxt || limitorder.ddqst) && showtx">
			...
			.timeselect-view {
				...
				.timeselect-detil {
					...
					.borderrights {
						...
						background-color: #096dd9 // border: 2upx solid #F5A623;
					}
				}
			}
		}
