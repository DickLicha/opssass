	...
	export default {
		data() {
			return {
				...
				collapseData:[
					{name:'订单信息',data:[
						{name:'用户订单',val:'',url:'/carBigCenter/carorder/carorder'},
						{name:'车辆操作记录',val:'',url:'/pages/switchloockinfo/switchloockinfo'},
						{name:'换电记录',val:'',url:'/carBigCenter/batteriesrecord/batteriesrecord'},
						{name:'维修记录',val:'',url:'/carBigCenter/carorbit/carorbit'},
						{name:'订单轨迹',val:'',url:'/map/map?type=0.1&&name=用户骑行轨迹'},
						{name:'车辆轨迹',val:'',url:'/map/map?type=0.4&&name=车辆轨迹'},
						{name:'最后一次扫码手机位置',val:'',url:'/map/map?type=0.2&&name=最后扫码位置'},
						{name:'车辆当前位置',val:'',url:'/map/map?type=0.3&&name=车辆当前位置'},
						]},
					// {name:'设防信息',data:[
					// 	{name:'是否设防:',val:'',url:''},
					// 	{name:'电池锁:',val:'',url:''},
