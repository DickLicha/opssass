		...
		data() {
			return {
				...
				carcenterdata3: [{
						name: '订单',
						val: '',
						url: '/carBigCenter/carorder/carorder'
					},
					{
						name: '车辆操作记录',
						val: '',
					...
					},
					{
						name: '换电记录',
						val: '',
						url: '/carBigCenter/batteriesrecord/batteriesrecord'
					},
					{
						name: '维修记录',
						val: '',
						url: '/carBigCenter/carorbit/carorbit'
					},
					{
						name: '车辆轨迹',
						val: '',
						url: '/map/map?type=0.1&&name=用户骑行轨迹'
					},
					{
						name: '最后一次扫码时手机位置',
						val: '',
						url: '/map/map?type=0.2&&name=最后扫码位置'
					},
					{
						name: '车辆当前位置',
						val: '',
						url: '/map/map?type=0.3&&name=车辆当前位置'
					},
					{
						name: 'ECU',
						val: '',
						url: '/carBigCenter/ecuview/ecuview'
					},
					{
						name: '电池',
						val: '',
						url: '/carBigCenter/batteryview/batteryview'
					},
					{
						name: '最近上报日志',
						val: '',
